...
float UpgradePerformanceFunctions::getFlavourTagEfficiency(float ptMeV, float eta, char flavour, TString tagger, int operating_point) {
  ...
  if (eta<0) eta = -eta;
  //if (eta>etamax[iopt]) eta = etamax[iopt];
  ...
  static TF2* fitfun[nopt*ntag*nopp*nfl] = {0};
  static TFile* ff = 0;
  int ix = ipar*nfl;
