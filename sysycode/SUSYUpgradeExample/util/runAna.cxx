...
int main( int argc, char* argv[] ) {
  ...
  string submitDir = "/afs/cern.ch/user/j/jerdmani/private/susyexamples/outdir_"+sample;
...
//SH::ScanDir().scanEOS(sh, "/eos/atlas/atlaslocalgroupdisk/dq2/rucio/user/aagaard/*.root");
  ...
  SH::SampleHandler sh;
  SH::readFileList(sh,"sample","/afs/cern.ch/user/j/jerdmani/private/susyexamples/"+sample + ".list");
